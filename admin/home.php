...
<body>	
	...
	<div class="row">
		<div class="col-md-8">
			<h3>Statistiques</h3>
			<iframe id="laframe" src="https://www.elevagelama.com/awstats/awstats.pl?config=www.elevagelama.com&framename=mainright" style="width:720px;height:500px;" frameborder="1" ></iframe>
		</div>
		<div class="col-md-4">
